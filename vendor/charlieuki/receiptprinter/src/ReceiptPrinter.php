...
class ReceiptPrinter
{
    ...
    public function setStore($name, $address, $phone, $email) {
        $this->store = new Store($name, $address, $phone, $email);
    }
    ...
    public function addItem($name, $qty, $custimization ,$price) {
        $item = new Item($name, $qty,$custimization, $price);
